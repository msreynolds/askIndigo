...
var handlers = {
   ...
   'ChangeDeviceIntent': function (intent) {
      console.log('Device Change Intent');
      setDevice(intent);
   },
   'GetVariableIntent': function (intent) {
      console.log('Get Variable Intent');
      getVariable(intent);
   },
   'RunActionIntent': function (intent) {
...
function setDevice(intent) {
   ...
   makeRequest(path, description, intent.slots.Device.value, requestType);
}
...
function runAction(intent) {
   ...
   makeRequest(path, description, intent.slots.ActionName.value, requestType);
}

/** request the value of a variable */
function getVariable(intent) {
   ...
   makeRequest(path, description, intent.slots.VariableName.value, requestType);
}
...
function makeRequest(path, description, slotValue, requestType) {
   console.log("\n\n" + description + "\n");
   ...
   digestRequest.request({
      ...
      this.emit(':tell', getSpeechOutput(error, body, slotValue, requestType));
   });
}
